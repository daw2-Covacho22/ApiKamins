...
router.post('/', [authJwt.verifyToken, authJwt.isAdmin], vehiclesCtrl.createVehicle)
...
router.delete('/:vehicleId', [authJwt.verifyToken, authJwt.isAdmin], vehiclesCtrl.deleteVehiclesById)
